...
IBYTE		*data Tmp_Pntr					_at_ 0x42;	// 1 byte
//											_at_ 0x43;	// Reserved
BYTE code	*data Tmp_code_pointer			_at_ 0x44;	// 2 bytes

IBYTE		Timer1msCnt						_at_ 0x46;
IBYTE		Timer5msCnt						_at_ 0x47;
IBYTE		Timer1SecCnt					_at_ 0x48;
...
XBYTE	SCI_Event_In_Index					_at_ 0x2B;
XBYTE	SCI_Event_Out_Index					_at_ 0x2C;
XBYTE	SCI_Event_Buffer[EVENT_BUFFER_SIZE] _at_ 0x2D;	// 9 bytes

XBYTE	SMI_Event_Data						_at_ 0x38;
...
XBYTE	EC_Indirect_Selection				_at_ 0x8F;	//@Jay20151125 [PATCH]
...
XBYTE	SPIRdWrSize							_at_ 0x9F;	// leox20150625 [PATCH] Access eFlash

XBYTE	HSPI_SelfRamCode_Index				_at_ 0xA0;
XBYTE	HSPI_tempcmd						_at_ 0xA1;
XBYTE	HSPI_FPT_timeout					_at_ 0xA2;
XBYTE	HSPI_Misc1							_at_ 0xA3;

XBYTE	PD_SCI_Event_In_Index				_at_ 0xA4;
XBYTE	PD_SCI_Event_Out_Index				_at_ 0xA5;
XBYTE	PD_SCI_Event_Buffer[PENDING_BUFFER] _at_ 0xA6;	// 8 bytes 0xA6 ~ 0xAD
//Reserved 0xAE~ 0xAF

//David_20120327 add for SMBUS reset timing follow SMBUS spec
XBYTE SMBus1Cunt							_at_ 0xB0;	// leox_20140128 [PATCH] Change offset from 0xEC~0xEF to 0xB0~0xB3 for JayFn
XBYTE SMBus2Cunt							_at_ 0xB1;
XBYTE SMBus3Cunt							_at_ 0xB2;
XBYTE SMBus4Cunt							_at_ 0xB3;
//David_20120327 add for SMBUS reset timing follow SMBUS spec
//Reserved 0xB4 ~ 0xCF

XBYTE   FnKeyBundledFlag[16]				_at_ 0xE0;	//@JayFn [PATCH]
