...
ECReg   HRAMW2BA        _at_ 0x1076;    // Host RAM Winodw 2 Base Address
ECReg   HRAMW3BA        _at_ 0x1077;    // Host RAM Window 3 Base Address
ECReg   HRAMW2AAS       _at_ 0x1078;    // Host RAM Window 2 Access Allow Size
ECReg   HRAMW3AAS       _at_ 0x1079;    // Host RAM Window 3 Access Allow Size
...
ECReg   ISR18           _at_ 0x115C;    // Interrupt Status Register 18
...
ECReg	GCR3			_at_ 0x16F2;	// General Control 3 Register			// leox_20120112 [PATCH]
...
ECReg	GCR9			_at_ 0x16F8;	// General Control 9 Register			// leox20150724 PWRSW_WDT_1 [PATCH]
ECReg	GCR10			_at_ 0x16F9;	// General Control 10 Register			// leox20150724 [PATCH]
ECReg	GCR11			_at_ 0x16FA;	// General Control 11 Register			// leox20150724 PWRSW_WDT_1 [PATCH]
...
ECReg   GPCRH7          _at_ 0x164F;    // Port Control H7 Registers            // leox_20141016 For IT8987 [PATCH]
...
ECReg	GPCRJ6			_at_ 0x165E;	// Port Control J6 Registers			// leox_20121213 [PATCH] Support_GPJ6_GPJ7
ECReg	GPCRJ7			_at_ 0x165F;	// Port Control J7 Registers			// leox_20121213 [PATCH] Support_GPJ6_GPJ7
...
ECReg   GPOTF           _at_ 0x1676;    // Output Type Register // leox_20131213 [PATCH]
ECReg	GPOTH			_at_ 0x1678;	// Output Type Register
ECReg   GPOTJ           _at_ 0x167A;    // Output Type Register // leox_20131213 [PATCH]

// Input voltage selection for IT8987   // Support_IT8987       // chris_20140924 [PATCH]
...
ECReg	DCR1			_at_ 0x1803;	// Channel 1 PWM Duty Cycle
ECReg	DCR2			_at_ 0x1804;	// Channel 2 PWM Duty Cycle
ECReg	DCR3			_at_ 0x1805;	// Channel 3 PWM Duty Cycle
ECReg	DCR4			_at_ 0x1806;	// Channel 4 PWM Duty Cycle
ECReg	DCR5			_at_ 0x1807;	// Channel 5 PWM Duty Cycle
ECReg	DCR6			_at_ 0x1808;	// Channel 6 PWM Duty Cycle
ECReg	DCR7			_at_ 0x1809;	// Channel 7 PWM Duty Cycle
...
//-----------------------------------------------------------------------------
ECReg	DACCTRL			_at_ 0x1A00;	// DAC Control Register			r/w b
...
ECReg	WUEMR7			_at_ 0x1B14;	// Wake-Up Edge Mode Register 7			// leox_20111109 [PATCH]
...
ECReg   WUESR8          _at_ 0x1B19;    //Wake-Up Edge Mode Register  8
ECReg   WUESR9          _at_ 0x1B1D;    //Wake-Up Edge Mode Register  9
ECReg   WUESR10         _at_ 0x1B21;    //Wake-Up Edge Mode Register 10
ECReg   WUESR11         _at_ 0x1B25;    //Wake-Up Edge Mode Register 11
ECReg   WUESR12         _at_ 0x1B29;    //Wake-Up Edge Mode Register 12
ECReg   WUESR13         _at_ 0x1B2D;    //Wake-Up Edge Mode Register 13
ECReg   WUESR14         _at_ 0x1B31;    //Wake-Up Edge Mode Register 14
...
ECReg	SMB4P7USL		_at_ 0x1C22;	// 4.7 us Low Register
ECReg	SMB4P0USH		_at_ 0x1C23;	// 4.7 us High Register
...
ECReg	SMB45P3USL		_at_ 0x1C27;	// 45.3 us Low Register
ECReg	SMB45P3USH		_at_ 0x1C28;	// 45.3 us High Register
ECReg	SMB4P7A4P0H		_at_ 0x1C33;	// 4.7 us and 4.0 us High Register

ECReg	SLVISELR		_at_ 0x1C34;	// Slave Interface Select Register		// 120614 chris add for not into debug mode for SMBus error [PATCH] // leox_20120810 SMBTESTMODE -> SLVISELR
ECReg	SCLKTS_A		_at_ 0x1C40;	// SMCLK Timing Setting Register A		// leox_20120718 [PATCH]
...
//+Jay20121203 add_polling_charger
...
ECReg	SPECTRL4		_at_ 0x201C;	// Special Control 4					// leox20150724 PWRSW_WDT_1 [PATCH]
...
ECReg	SPICTRL1		_at_ 0x2601;	// SPI Control Register 1
ECReg	SPICTRL2		_at_ 0x2602;	// SPI Control Register 2
ECReg	SPICTRL3		_at_ 0x2604;	// SPI Control Register 3
ECReg	SPISTS			_at_ 0x2603;	// SPI Start and End Status Register
...
ECReg	HOCTL2R			_at_ 0x3008;	// Host Control 2 Register		// leox_20131129 [PATCH]
ECReg	PADCTLR			_at_ 0x300E;	// Pad Control Register			// leox20150729 PECI setting for IT8987 [PATCH]
