...
sbit F_Service_OEM_1        = Service1 ^ 2;
sbit F_Service_OEM_2        = Service1 ^ 3;
sbit F_Service_OEM_3        = Service1 ^ 4;
sbit F_Service_PCI4         = Service1 ^ 5;
sbit F_Service_Low_LV       = Service1 ^ 6;
...
sbit ChkAUXRespFlag4        = CustomFlag ^ 6;
//+JayFn [PATCH]
//sbit CustomFlag_RV2       = CustomFlag ^ 7;
